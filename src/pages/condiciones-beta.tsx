        ...
        <>
            ...
            <main className="jh-site jh-legal-page">
                ...
                <article className="jh-legal jh-surface">
                    ...
                    <p>Antes de habilitar un checkout directo o aceptar un pago se informarán al comprador el precio total aplicable, alcance de la versión adquirida, forma de entrega, condiciones de soporte, identificación del proveedor y demás antecedentes que correspondan a una contratación electrónica en Chile. La compra deberá quedar confirmada por escrito.</p>
