    ...
    return (
        <>
            <Head>
                ...
                <meta name="description" content="Política de privacidad de JoinHook y Estado de Gastos Operacionales durante su etapa beta local-first." />
            ...
            <main className="jh-site jh-legal-page">
                ...
                <article className="jh-legal jh-surface">
                    ...
                    <h1>Privacidad en JoinHook y Estado de Gastos Operacionales</h1>
                    <p>JoinHook es un proyecto independiente de Francisco Javier Campos. Esta política describe el funcionamiento de privacidad de la web y de la beta actual de Estado de Gastos Operacionales.</p>

                    <h2>1. Datos operativos de Estado de Gastos Operacionales</h2>
                    ...
                    <h2>7. Cambios</h2>
                    <p>Estado de Gastos Operacionales está en beta. Si cambia la arquitectura —por ejemplo al incorporar cuentas, sincronización cloud o pagos— esta política también deberá cambiar antes de utilizar esas funciones.</p>
