...
export default function Home() {
    return (
        <PageShell>
            <SiteHead
                title="JoinHook | Soluciones digitales con mirada operativa"
                description="JoinHook diseña y desarrolla soluciones digitales, sistemas, PWA, automatizaciones y productos tecnológicos a partir de necesidades operativas reales en Chile."
                path="/"
                jsonLd={{
            ...
            <section className="jh3-section">
                ...
                <div className="jh3-grid-4">
                    {services.map(([icon, title, text]) => (
                        <article key={title} className="jh3-card jh3-card-lift jh3-feature-card">
                            <IconBadge name={icon} />
                            <h3>{title}</h3>
                            <p>{text}</p>
                        </article>
            ...
            <section className="jh3-section">
                ...
                <div className="jh3-process">
                    {process.map(([icon, title, text]) => (
                        <article key={title} className="jh3-card jh3-process-card">
                            <IconBadge name={icon} />
                            <h3>{title}</h3>
                            <p>{text}</p>
                        </article>
            ...
            <section className="jh3-section">
                <div className="jh3-founder-feature jh3-card">
                    <div className="jh3-founder-photo-wrap">
                        <img src="/images/francisco-javier-campos.jpg" alt="Francisco Javier Campos en un entorno natural del sur de Chile" loading="lazy" />
                    </div>
                    <div className="jh3-founder-feature-copy">
                        <span className="jh3-eyebrow">Nuestra mirada</span>
                        <h2>Experiencia de operación convertida en criterio de diseño.</h2>
