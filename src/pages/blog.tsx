                ...
                <section className="jh-note-grid" aria-label="Notas publicadas y en preparación">
                    {notes.map((note, index) => (
                        <article className="jh-surface jh-note-card" key={note.title}>
                            ...
                            <h2>{note.title}</h2>
                            <p>{note.text}</p>
                            <span className="jh-note-link">Próximamente ↗</span>
                        </article>
                    ))}
                </section>
