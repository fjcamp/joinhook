        ...
        <main className="cge-app">
            ...
            <section className="cge-main">
                <header className="cge-topbar">
                    <div><span className="cge-kicker">JoinHook · MVP 0.2</span><h1>{views.find((item) => item.key === view)?.label}</h1></div>
